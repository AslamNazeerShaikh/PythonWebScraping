...
if ( $hasHostnames$ ) {
    const $scriptletHostnames$ = /* 34 */ ["no","bt.dk","tu.no","vg.no","e24.no","tek.no","tv2.no","bold.dk","digi.no","vgtv.no","bankid.*","blogg.no","gamer.no","senest.dk","spleis.no","connery.dk","postnord.*","3dsecure.no","eurosport.*","inputmag.dk","techstart.dk","tvkampen.com","tvsporten.dk","berlingske.dk","gamereactor.*","nakenprat.com","norges.online","downdetector.dk","downdetector.no","maskinbladet.dk","sonderborgnyt.dk","embed.viaplay.com","www-vg-no.translate.goog","www-tv2-no.translate.goog"];
    ...
    if ( todoIndices.size ) {
        const $scriptletArglistRefs$ = /* 34 */ "19;23;4;7,9,14;9;9;5,13;20;9;5;-20;1;4,9;27;22;18;-20;-20;11;25;12;6;6;10;15,16,17;2;8;21;21;26;3;24;7;5";
